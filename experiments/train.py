...
def get_trainers(env, num_adversaries, obs_shape_n, arglist):
    ...
    for i in range(num_adversaries):
        trainers.append(trainer(
            ...
            local_q_func=(arglist.adv_policy=='ddpg'), preprocessors=(preprocessors if arglist.adv_policy=="preprocess" or arglist.preprocess else None), preproc_idx=preproc_idx))
